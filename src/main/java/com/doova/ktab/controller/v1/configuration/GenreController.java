package com.doova.ktab.controller.v1.configuration;
...
public class GenreController {
    ...
    public ResponseEntity<ApiResponse<MainGenreDTO>> createGenre(@Valid @RequestPart("genreDto") MainGenreDTO genreDto, @RequestPart(value = "subGenres", required = false) List<SubGenreDTO> subGenres) {
    ...
    public ResponseEntity<ApiResponse<MainGenreDTO>> updateGenre(@PathVariable Long id, @Valid @RequestPart("genreDto") MainGenreDTO genreDto, @RequestPart(value = "subGenres", required = false) List<SubGenreDTO> subGenres) {
        genreDto.setId(id);
        genreDto.setSubGenres(subGenres);
