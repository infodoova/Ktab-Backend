...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<String>> login(@Valid @RequestBody UserLoginRequest req) {
        ...
        return ResponseUtils.success(token, ApiMessageKey.AUTH_LOGIN_SUCCESS.getMessage(messageSource), HttpStatus.OK);
    }
    ...
    public ResponseEntity<ApiResponse<Void>> verify(@RequestBody VerifyCodeRequest req) {
    ...
    public ResponseEntity<ApiResponse<Void>> sendReset(@RequestBody SendResetPasswordRequest req) {
    ...
    public ResponseEntity<ApiResponse<String>> refreshToken(@CurrentUser User user) {
        ...
        return ResponseUtils.success(token, ApiMessageKey.OPERATION_SUCCESS.getMessage(messageSource), HttpStatus.OK);
    }
}
